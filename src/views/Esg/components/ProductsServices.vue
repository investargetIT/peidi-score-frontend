<template>
  <div class="esg-content">
    ...
    <el-collapse v-model="activeCollapse" class="esg-collapse">
      <el-collapse-item title="方针与目标" name="industry-value-finance">
        <template #title>
          ...
          <el-form :model="formData" label-position="left" label-width="100px">
            ...
            <el-form-item label="目标、理念方针及承诺">
              ...
              <el-input
                ...
                :rows="4"
                resize="vertical"
                placeholder="食品质量安全始终是双汇发展企业管理的首位，并已经成为企业文化的重要组成。我们的食品 安全控制体系践行“预防为主、风险管理、全员参与、全程控制”的原则，以科技智能为工具优 化安全管理，同时深化产品营养研发，实现食品安全和品质从源头到销售的全过程管控，做消费者信赖的肉类食品企业。2023年，双汇发展坚持并落实六大质量目标，其下涵盖69项质量指标，涉及研发、供应生产、储存、运输5个环节，我们严格推进六大目标的关键指标管理，落实质量管理举措，并全面跟踪质量关键节点绩效表现。 ——《双汇发展2023年ESG报告》"
              />
            </el-form-item>
      ...
      <el-collapse-item title="体系及策略" name="strategy-goals">
        <template #title>
          <div class="collapse-title">
            <span
              >体系及策略
...
Wind评级"
          ...
          <el-form :model="formData" label-position="left" label-width="100px">
            ...
            <el-form-item label="组织架构">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="双汇发展已建有一个权责清晰的集团级、事业部级、项目公司级三级食品安全管理架构，推进和落实产品质量控制和保障工作。我们设有食品安全监督小组，负责推进和敦促各项食品安全 管理措施的执行。品质管理中心负责生产基地的驻厂督导和检验，并按照《双汇发展2023年项目公司质量管理评价方案》执行绩效考核。我们每月进行质量指标的跟踪，不断推动质量管理 工作的有效实施，保障食品质量与安全。 ——《双汇发展2023年ESG报告》"
                resize="vertical"
              />
            </el-form-item>
            <el-form-item label="政策与制度">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="双汇发展以最严谨的标准、最严格的监督、最严厉的处理、最严肃的问责“四个最严”作为质量 管理的总体原则，严格遵循《中华人民共和国食品安全法》《中华人民共和国食品安全法实施条例》《中华人民共和国产品质量法》《企业落实食品安全主体责任监督管理规定》等国家法 律和地方法规，各产业运行基于国际标准的质量管理体系，制定《双汇发展食品安全事故应急 预案》《卫生标准操作规范》等质量管理制度和操作规程，并不断优化《双汇发展2023年项 目公司质量管理评价方案》《双汇发展产品质量、食品安全考核管理规定》等管理和监督制度和程序，以达到公司各产业质量标准。 ——《双汇发展2023年ESG报告》"
                resize="vertical"
              />
            </el-form-item>
            <el-form-item label="全周期产品质量管理">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="上海梅林旗下各企业围绕质量和食品安全管理体系，从原辅料、产品、生产工艺、危害分析工作表对食品安全风险控制提出了要求和识别。对于体系覆盖的产品建立了HACCP计划，根据计划实施关键点控制。 我们围绕《食品安全法》与质量和食品安全管理体系的要求，制定了《产品模拟追溯演练管理办法》《产品召回管 理办法》等制度，建立产品可追溯性控制程序，实现从原辅料到销售全过程的追溯，以方便消费者通过追溯系统对 整个生产过程进行溯源，进而保障食品质量安全可靠。 ——《上海梅林2023年ESG 暨可持续发展报告》"
                resize="vertical"
              />
            </el-form-item>
            <el-form-item label="认证与审验">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="双汇发展的下属生产企业按业务属性和需要获得和保有多个 国际质量管理体系认证。报告期内，2家下属公司新增相关认证:汇佳味公司获得ISO 9001认 证，食用油科技公司获得ISO 9001认证和HACCP认证。截止2023年底，本公司拥有的质量体系认证情况如下:双汇发展及其下属公司100%保有ISO 9001质量管理体系认证，共覆盖42家公 司;涉及屠宰和肉制品加工的公司拥有HACCP危害分析与关键控制点体系认 证，已覆盖17家公司;ISO 22000食品安全管理体系覆盖16家公司;我们亦根据国际客户的需求定向申请FSSC 22000食品安全管理体系认证，覆盖6家公 司。 ——《双汇发展2023年ESG报告》"
              />
            </el-form-item>
            ...
            <el-form-item label="宣贯与培训">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="双汇发展秉持“产品质量无小事，食品安全大如天”的理念，致力于以自上而下的方式打造质量 文化，通过每年组织开展系统性、专业性的质量培训，培养员工及合作伙伴的质量意识和技能， 确保产品质量的持续提升。同时，我们每月组织工厂召开质量专题会，主要通报各工厂在质量 管理方面存在的短板指标，督促相对排名靠后的工厂分析原因并及时反馈和进行必要整改，形成解决质量问题的长效机制。 报告期内，我们举办劳动比赛、技术比武176场次，开展食品安全质量知识竞赛、安全生产知识 竞赛56场次，有效提高职工实际岗位技能，加强员工团结协作融合。我们每年开展质量安全相关培训，2023年共开展5,235次培训，参与培训468,215人次，培训时长总计1,224,490时，员工培训覆盖率100%。 ——《双汇发展2023年ESG报告》"
              />
            </el-form-item>
            <el-form-item label="附件上传" prop="honorsAndRecognitionFileList">
              <template #label>
      ...
      <!-- 其他折叠项 -->
      <el-collapse-item title="质量管理实践" name="system-strategy">
        <template #title>
          <div class="collapse-title">
            <span
              >质量管理实践
...
Wind评级"
          ...
          <el-form :model="formData" label-position="left" label-width="100px">
            <el-form-item label="活动与举措">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="本集团食品安全中心在各级领导的支持下，带领团队，高举GMP大旗，紧紧围绕「100-1=0」的管理理念，积极推进 并落实日常GMP改善计划追踪工作， 稽核内容逐年细化精进，稽核水平逐年提升。食品、肉品同步管理，硬件和软件同步精进，消除短板，加长长板，共同达成1+1≥2的目的;稽核内容有基本 硬件设施要求和维护、收发货和仓储管 理、设备维护保养校准人员卫生要求和 培训、清洁消毒和虫鼠管理、追溯体系、异物和过敏源管理HACCP计划、 SOP落地执行9个模块。本集团共12个被稽核单位，总分100%达成90分以上 好成绩。团队整体表现优秀，持续改善一直在进行中，为质量管理目标的圆满达成奠定了良好的基础。 ——《大成食品2023年环境、社会及管治报告》"
              />
            </el-form-item>
            <el-form-item label="附件上传" prop="honorsAndRecognitionFileList">
              <template #label>
      ...
      <el-collapse-item title="管理体系" name="scientific-ethics">
        <template #title>
          <div class="collapse-title">
            <span
              >管理体系
          ...
          <el-form :model="formData" label-position="left" label-width="100px">
            ...
            <el-form-item label="安全生产管理制度体系">
              ...
              <el-input
                ...
                :rows="4"
                resize="vertical"
                placeholder="旺旺严格遵守《中华人民共和国安 全生产法》《中华人民共和国消防法》 《生产安全事故应急预案管理办法》等法 律法规，结合地方实际新增的《安全生产投入管理办法》《文件档案管理办法》 《变更管理办法》《安全警示标志管理制度》《相关方管理办法》5份内部安全管理制度，结合入职健康证明、员工团体保险、僱主责任险、海外旅游险等方面， 保证员工的工作安全和身体健康。集团积 极建立标准化的、全面的旺旺标准安全管理WSSM三阶安全管理体系，确保制度的适用性及有效落地，保障当地工厂生产运营的安全稳定。2022财年，集团为落实 全员安全生产责任制，及时修订了安全责 任书内容，工厂安全生产责任书签订率达 100%。 ——《中国旺旺2022/23年环境、社会及管治报告》"
              />
            </el-form-item>
            <el-form-item label="安全生产管理组织架构">
              ...
              <el-input
                ...
                :rows="4"
                resize="vertical"
                placeholder="为保障员工健康安全，本集团各工厂建立生产 三级安全体系，即厂长、现场主管、一线员工，三级管理防控;同时，将安全指标纳入三类人群月度绩效奖金考核，确保员工健康安全机制得以落地实施并得到所有员工及主管的重视。 ——《大成食品2023年环境、社会及管治报告》"
              />
            </el-form-item>
          </el-form>
        </div>
      ...
      <el-collapse-item title="管理实践" name="achievements-honors">
        <template #title>
          <div class="collapse-title">
            <span
              >管理实践
      ...
      <el-collapse-item title="危害及风险评估和调查" name="innovation-impact">
        <template #title>
          <div class="collapse-title">
            <span>
              危害及风险评估和调查
      ...
      <el-collapse-item title="产品信息与标识" name="sustainable-design">
        <template #title>
          <div class="collapse-title">
            <span
              >产品信息与标识
...
——《上海梅林2023年ESG 暨可持续发展报告》"
      ...
      <el-collapse-item title="市场营销" name="cooperation-mechanism">
        <template #title>
          <div class="collapse-title">
            <span>
              市场营销
      ...
      <el-collapse-item title="产品可及性" name="standards-establishment">
        <template #title>
          <div class="collapse-title">
            <span>
              产品可及性
          ...
          <el-form :model="formData" label-position="left" label-width="100px">
            <el-form-item>
              ...
              <el-input
                ...
                type="textarea"
                :rows="6"
                placeholder="我们通过传统节日微电影拍摄、综艺年轻化营销、线上线下多平台明星营销推广等方式，向不   同年龄段消费者普及食品健康相关知识。2023年，我们持续探索负责任营销和责任品牌建设路径，通过开展体育运动相关营销活动，树立健康消费新标杆，向社会传递大健康消费理念。     ——《双汇发展2023年ESG报告》"
              />
            </el-form-item>
          </el-form>
        </div>
      </el-collapse-item>
      <el-collapse-item title="客户评价" name="industry-activities">
        <template #title>
          <div class="collapse-title">
            <span>
              客户评价
      ...
      <el-collapse-item title="产品召回" name="management-system">
        <template #title>
          <div class="collapse-title">
            <span>
              产品召回
          ...
          <el-form :model="formData" label-position="left" label-width="100px">
            <el-form-item>
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="一级程度,经济损失在5000元以上 1超保质期 2标签信息批量错误(品名、生产日 期错误) 3生产日期批量打印模糊或缺失 4产品批量变质 5来自政府和新闻媒介或相关部门的投诉; 6社会后果严重或将会引发一系列具 有社会影响的问题; 7涉及产品安全问题的投诉。 批量指同批次产品发生投诉或退货数量在10件以上。48h内做应14日内提出解 决方案。按《食品质量安全预与应急处置预案》执行 是否启动产品召回程序 由公司总经理决定，若 启动则按《产品召回控制程序》流程处理，所有的纠正措施实施须由责任部门分管领导派有关人员予以验证提交技质部管理评审、跟踪。 ——《上海梅林2023年ESG 暨可持续发展报告》<br/> 为切实保障消费者健康与安全，预防发生产品缺陷事件造成广泛影响，双汇发展未雨绸缪，每 年按照《产品召回控制操作规范》组织模拟召回，报告期内，各项目公司均组织2次产品召回演练，锻炼产品召回能力，发现问题及时改进。报告期内，未发生任何产品召回事件。 ——《双汇发展2023年ESG报告》"
              />
            </el-form-item>
            <el-form-item>
              <template #label>
