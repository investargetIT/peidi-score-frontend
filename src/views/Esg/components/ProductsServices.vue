          ...
          >
            ...
            <el-form-item label="目标、理念方针及承诺">
              ...
              <el-input
                ...
                :rows="4"
                resize="vertical"
                placeholder="【提示】食品质量安全始终是双汇发展企业管理的首位，并已经成为企业文化的重要组成。我们的食品安全控制体系践行预防为主、风险管理、全员参与、全程控制的原则，以科技智能为工具优化安全管理，同时深化产品营养研发，实现食品安全和品质从源头到销售的全过程管控，做消费者信赖的肉类食品企业。2023年，双汇发展坚持并落实六大质量目标，其下涵盖69项质量指标，涉及研发、供应生产、储存、运输5个环节，我们严格推进六大目标的关键指标管理，落实质量管理举措，并全面跟踪质量关键节点绩效表现。——双汇发展2023年ESG报告"
              />
            </el-form-item>
          ...
          >
            ...
            <el-form-item label="组织架构">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】双汇发展已建有一个权责清晰的集团级、事业部级、项目公司级三级食品安全管理架构，推进和落实产品质量控制和保障工作。我们设有食品安全监督小组，负责推进和敦促各项食品安全管理措施的执行。品质管理中心负责生产基地的驻厂督导和检验，并按照《双汇发展2023年项目公司质量管理评价方案》执行绩效考核。我们每月进行质量指标的跟踪，不断推动质量管理工作有效实施，保障食品质量与安全。 ——《双汇发展2023年ESG报告》"
                resize="vertical"
              />
            </el-form-item>
            <el-form-item label="政策与制度">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】双汇发展以最严谨的标准、最严格的监督、最严厉的处理、最严肃的问责四个最严作为质量管理的总体原则，严格遵循中华人民共和国食品安全法、中华人民共和国食品安全法实施条例、中华人民共和国产品质量法、企业落实食品安全主体责任监督管理规定等国家法律和地方法规，各产业运行基于国际标准的质量管理体系，制定双汇发展食品安全事故应急预案、卫生标准操作规范等质量管理制度和操作规程，并不断优化双汇发展2023年项目公司质量管理评价方案、双汇发展产品质量、食品安全考核管理规定等管理和监督制度和程序，以达到公司各产业质量标准。——双汇发展2023年ESG报告"
                resize="vertical"
              />
            </el-form-item>
            <el-form-item label="全周期产品质量管理">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】上海梅林旗下各企业围绕质量和食品安全管理体系，从原辅料、产品、生产工艺、危害分析工作表对食品安全风险控制提出了要求和识别。对于体系覆盖的产品建立了HACCP计划，根据计划实施关键点控制。 我们围绕《食品安全法》与质量和食品安全管理体系的要求，制定了《产品模拟追溯演练管理办法》《产品召回管理办法》等制度，建立产品可追溯性控制程序，实现从原辅料到销售全过程的追溯，以方便消费者通过追溯系统对整个生产过程进行溯源，进而保障食品质量安全可靠。 ——《上海梅林2023年ESG 暨可持续发展报告》"
                resize="vertical"
              />
            </el-form-item>
            ...
            <el-form-item label="附件上传" prop="certificationAndAuditFileList">
              ...
              <el-upload
                ...
                :on-success="
                  handleUploadSuccess('certificationAndAuditFileList')
                "
            ...
            <el-form-item label="宣贯与培训">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】双汇发展秉持产品质量无小事，食品安全大如天的理念，致力于以自上而下的方式打造质量文化，通过每年组织开展系统性、专业性的质量培训，培养员工及合作伙伴的质量意识和技能，确保产品质量的持续提升。同时，我们每月组织工厂召开质量专题会，主要通报各工厂在质量管理方面存在的短板指标，督促相对排名靠后的工厂分析原因并及时反馈和进行必要整改，形成解决质量问题的长效机制。报告期内，我们举办劳动比赛、技术比武176场次，开展食品安全质量知识竞赛、安全生产知识竞赛56场次，有效提高职工实际岗位技能，加强员工团结协作融合。我们每年开展质量安全相关培训，2023年共开展5235次培训，参与培训468215人次，培训时长总计1224490时，员工培训覆盖率100%。——双汇发展2023年ESG报告"
              />
            </el-form-item>
            <el-form-item label="附件上传" prop="trainingAndPromotionFileList">
              ...
              <el-upload
                ...
                :before-upload="handleFileBeforeUpload"
                :on-success="
                  handleUploadSuccess('trainingAndPromotionFileList')
                "
                :on-remove="handleUploadRemove"
                drag
                :action="uploadUrl"
          ...
          >
            ...
            <el-form-item label="附件上传" prop="qualityPracticeFileList">
              ...
              <el-upload
                ...
                :on-change="handleFileChange"
                :before-upload="handleFileBeforeUpload"
                :on-success="handleUploadSuccess('qualityPracticeFileList')"
                :on-remove="handleUploadRemove"
                drag
                :action="uploadUrl"
                :auto-upload="true"
            ...
            <el-form-item label="附件上传" prop="honorsAndAwardsFileList">
              ...
              <el-upload
                ...
                :on-change="handleFileChange"
                :before-upload="handleFileBeforeUpload"
                :on-success="handleUploadSuccess('honorsAndAwardsFileList')"
                :on-remove="handleUploadRemove"
                drag
                :action="uploadUrl"
                :auto-upload="true"
          ...
          >
            <el-form-item label="安全生产价值理念与目标">
              ...
              <el-input
                ...
                :rows="4"
                resize="vertical"
                placeholder="【提示】本集团一直秉承'诚信、谦和、前瞻'的理念进行肉鸡生产，对肉鸡养殖到肉鸡屠宰进行全过程管理。本集团下属蚌埠食品厂成立以总经理为总负责人，下设各部门主管负责的动物福利委员会，从养殖过程到屠宰过程以动物福利五大原则为基础进行生产管理，从养殖的一线员工到屠宰的一线员工进行岗前、岗中的动物福利培训与考核，程序文件完全遵守国家法律法规，由取得国家级资格证书的人员负责。本集团坚持提供动物福利，以持续改善的动物福利创造更优的经济动物价值，奉献安全、美味的鸡肉食品。 ——《大成食品2023年环境、社会及管治报告》"
              />
            </el-form-item>
            ...
            <el-form-item label="安全生产管理组织架构">
              ...
              <el-input
                ...
                :rows="4"
                resize="vertical"
                placeholder="【提示】为保障员工健康安全，本集团各工厂建立生产三级安全体系，即厂长、现场主管、一线员工，三级管理防控;同时，将安全指标纳入三类人群月度绩效奖金考核，确保员工健康安全机制得以落地实施并得到所有员工及主管的重视。 ——《大成食品2023年环境、社会及管治报告》"
              />
            </el-form-item>
          </el-form>
        </div>
          ...
          >
            <el-form-item label="培训与宣导">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】公司始终将员工的安全作为企业稳定发展的脉搏所在，通过组织开展丰富多样的安全教育培训活动，2023年上海梅林共组织安全教育培训活动705次，参加安全培训54114人次，其中安全管理人员5342人次、职工人员33757人次、外来劳务人员15015人次。使广大干部员工不断增强安全意识、掌握安全知识技能、提升安全履职能力，为进一步提高公司安全生产管理水平奠定了良好基础。 ——《上海梅林2023年ESG 暨可持续发展报告》"
              />
            </el-form-item>
            <el-form-item label="附件上传" prop="safetyTrainingFileList">
              ...
              <el-upload
                ...
                :on-change="handleFileChange"
                :before-upload="handleFileBeforeUpload"
                :on-success="handleUploadSuccess('safetyTrainingFileList')"
                :on-remove="handleUploadRemove"
                drag
                :action="uploadUrl"
                :auto-upload="true"
            ...
            <el-form-item label="安全风险识别与检查">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】2023年，本公司重点围绕消防、特种设备、安全生产等相关标准进行了风险点评估，深入分析了各环节可能存在的安全隐患，对识别出的风险进行了相应的改造和优化，不仅提升了企业的安全管理水平，也为员工创造了一个更加安全、健康的工作环境。 我们通过设施更新、应急演练和安全排查，从风险源头管控、预防消除隐患，维护安全的作业环境，保障员工和财产安全。对已发生的事故，我们采取了相应的纠正措施，以预防未来再次发生类似事件。 ——《双汇发展2023年ESG报告》"
              />
            </el-form-item>
            <el-form-item label="安全应急事件管理">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】2023年各单位共进行各类应急演练1,287场次，累计参加应急演练人员19万余人次。 ——《双汇发展2023年ESG报告》"
              />
            </el-form-item>
            <el-form-item label="附件上传" prop="emergencyManagementFileList">
              ...
              <el-upload
                ...
                :on-change="handleFileChange"
                :before-upload="handleFileBeforeUpload"
                :on-success="handleUploadSuccess('emergencyManagementFileList')"
                :on-remove="handleUploadRemove"
                drag
                :action="uploadUrl"
                :auto-upload="true"
            ...
            <el-form-item label="装备安全管理">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】公司所属公司加装粉尘过滤设备，为了降低筛分场 所内的粉尘浓度，保护作业环境安全性，确保原辅 料车间的洁净度。设备安全投入23.2万元。 ——《上海梅林2023年ESG 暨可持续发展报告》"
              />
            </el-form-item>
          </el-form>
        </div>
          ...
          >
            <el-form-item label="识别评估工作场所潜在危害和风险因素的程序">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】我们始终将员工的职业健康放在首位，并采取了一系列的管理举措，保障全体员工的健康与安全。报告期内，我们通过识别职业危害因素岗位，定期进行职业病危害因素检测，配备职业病危害防护用品等措施，保障员工的健康安全。我们对各单位接触职业危害因素的岗位员工定期进行职业健康体检，共覆盖5,200余名接触职业危害因素的员工，投入约60万元。 ——《双汇发展2023年ESG报告》"
              />
            </el-form-item>
          </el-form>
        </div>
          ...
          >
            <el-form-item>
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】据销售宣传需要，相关部门配合品牌市场提供相应的产品特点、烹饪方法、营养成分标注等方面的技术支撑，并积 极督促引导下属子公司严格落实食品安全责任，规范经营行为,同时考虑到产品受众群体对产品的营养、感官、体验感等因素，将产品营养成分标注于产品外包装上，供顾客参考。
...
——《双汇发展2023年ESG报告》"
            ...
            <el-form-item>
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】2023年，公司不存在夸大其词、隐瞒风险、过度营销等无底线营销产品的违法行为。
          ...
          >
            <el-form-item>
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】双汇发展秉持负责任的营销理念，规避不公平营销或虚假宣传行为发生的同时，积极宣导健康产品理念，引导消费者合理膳食，构建健康、均衡、营养的生活方式。我们严格遵守《中华人民共和国广告法》等相关法律法规，开展广告投放工作。     ——《双汇发展2023年ESG报告》"
              />
            </el-form-item>
          </el-form>
        </div>
          ...
          >
            <el-form-item>
              ...
              <el-input
                ...
                type="textarea"
                :rows="6"
                placeholder="【提示】我们通过传统节日微电影拍摄、综艺年轻化营销、线上线下多平台明星营销推广等方式，向不同年龄段消费者普及食品健康相关知识。2023年，我们持续探索负责任营销和责任品牌建设路径，通过开展体育运动相关营销活动，树立健康消费新标杆，向社会传递大健康消费理念。     ——《双汇发展2023年ESG报告》"
              />
            </el-form-item>
          </el-form>
        </div>
          ...
          >
            <el-form-item>
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】客户及消费者投诉处理流程：受理相关问题，创建投诉工单；通过信息化系统将相关投诉工单分配至相关部门与人员；统计投诉问题及基本情况，在1小时内通过工单流转到具体业务人员。 ——《双汇发展2023年ESG报告》<br/> 客户权益的保护是我们首要责任。真诚用心服务客户， 我们持续健全客户投诉机制，规范投诉的受理与反馈， 畅通内部沟通渠道，贯彻落实整改情况并及时反馈客户， 切实保障客户合法权益。公司收到客诉81起，较去年下降22起。 ——《中粮糖业2023年环境、社会及治理报告》"
              />
            </el-form-item>
            <el-form-item>
              <template #label>
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】2023年上海梅林及其下属子公司通过公布投诉电话、市场调查、走访客户、电话、邮件、QQ、微信、手机等客服平台等方式，对零售市场、团购市场和消费者进行满意度调查，调查对象采取随机抽样法，综合客户满意率为95.78%，消费者对上海梅林产品质量和服务质量较认可。 ——《上海梅林2023年ESG 暨可持续发展报告》"
              />
            </el-form-item>
          </el-form>
        </div>
...
// 没有给form-item添加prop属性，导致表单初始化无效，用一个空对象存储数据, 深拷贝
