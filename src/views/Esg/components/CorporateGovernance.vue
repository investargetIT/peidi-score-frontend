          ...
          >
            ...
            <el-form-item label="附件上传" prop="governanceStructureFiles">
              ...
              <el-upload
                ...
                :on-success="handleUploadSuccess('governanceStructureFiles')"
          ...
          >
            ...
            >
              ...
              <el-upload
                ...
                :on-change="handleFileChange"
                :before-upload="handleFileBeforeUpload"
                :on-success="handleUploadSuccess('boardCompositionFiles')"
                :on-remove="handleUploadRemove"
                drag
                :action="uploadUrl"
                :auto-upload="true"
          ...
          >
            <el-form-item label="董事会多元化声明">
              ...
              <el-input
                ...
                type="textarea"
                :rows="8"
                placeholder="【提示】公司在规划董事会成员时,充分考虑董事会成员的多元化,包括但不限于性别、年龄、文化及教育背景、专业经验、技能等。
 ——《一鸣食品2023年ESG报告》"
              />
            </el-form-item>
            <el-form-item label="董事会成员背景">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】公司现有董事会成员具有经济管理、财务、生物工程以及食品营养研究等多领域专业背景和工作经验,为公司决策提供坚实的支撑和保障。
 ——《一鸣食品2023年ESG报告》"
              />
            </el-form-item>
          ...
          >
            <el-form-item label="董事培训">
              ...
              <el-input
                ...
                :rows="4"
                resize="vertical"
                placeholder="【提示】2023年，董事办组织公司董事、监事、高管参加中国上市公司协会和四川上市公司关于独董制度改革、关键人培训、注册制解读、信息披露相关培训共计5次。确保董监高学习了解最新的上市监管法律法规，以更好的开展公司经营管理及决策工作。
 ——《水井坊2023年度ESG报告》"
              />
            </el-form-item>
            <el-form-item label="附件上传" prop="boardTrainingFiles">
              ...
              <el-upload
                ...
                :on-change="handleFileChange"
                :before-upload="handleFileBeforeUpload"
                :on-success="handleUploadSuccess('boardTrainingFiles')"
                :on-remove="handleUploadRemove"
                drag
                :action="uploadUrl"
                :auto-upload="true"
          ...
          >
            <el-form-item label="董事会独立性声明">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】伊利制定《公司独立董事制度》，并严格按照《公司独立董事制度》中规定的任职条件和选举程序选聘符合要求的专家、权威人士为独立董事，独立董事4名，占董事会人数的1/3以上。 ——《伊利股份2023年可持续发展报告》"
              />
            </el-form-item>
...
4.与组织的影响相关的胜任能力。"
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】公司在规划董事会成员时,充分考虑董事会成员的多元化,包括但不限于性别、年龄、文化及教育背景、专业经验、技等。公司董事会由7名董事组成，其中女性董事2名,占比29%。公司现有董事会成员具有经济管理、财务、生物工程以及食品营养研究等多领域专业背景和工作经验,为公司决策提供坚实的支撑和保障。——《一鸣食品2023年ESG报告》"
              />
            </el-form-item>
          </el-form>
        </div>
          ...
          >
            <el-form-item>
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】公司聘请执业律师出席股东大会，进行确认和见证，保证股东大会的合法有效性，股东大会切实维护全体股东、特别是中小股东的合法权益。按照股东大会决议及授权，本着对全体股东负责的态度，公司对股东大会审议通过的各项议案和事项及时办理，确保股东大会各项决议顺利执行。——《中粮糖业2023年度ESG报告》"
              />
            </el-form-item>
            <el-form-item>
              <template #label>
...
需说明董事会在制定、批准、更新及监督公司可持续发展（ESG）相关目标和程序方面的作用。"
            ...
            <el-form-item>
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】公司董事会专门委员会充分发挥专门委员会职责，对提交董事会议题进行事先讨论和审议，协助董事会做好专业决策，更高效地行使董事会职权。——《中粮糖业2023年度ESG报告》"
              />
            </el-form-item>
            <el-form-item>
              <template #label>
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】对董事会的决议是否符合有关法律法规以及对公司日常经营、财务管理等方面认真开展监督工作，促进公司依法合规运行，维护公司和全体股东的合法权益。——《中粮糖业2023年度ESG报告》"
              />
            </el-form-item>
            <el-form-item>
              <template #label>
          ...
          >
            <el-form-item>
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】公司构建多维度的董事会成员绩效评价体系，综合公司生产经营管理情况、经营目标完成情况、财务预算执行情况及工作履职情况来决定绩效评价。其中，独立董事的薪酬经公司股东大会审议通过，职工董事的薪酬根据公司的薪酬管理制度以及个人的绩效考评结果来综合评估。 ——《贵州茅台2023年ESG报告》"
              />
            </el-form-item>
            <el-form-item label="高管薪酬与ESG表现挂钩">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】为确保实现可持续发展目标承诺，伊利的可持续发展战略目标与经营战略目标一样，成为集团高级管理人员（负责可持续发展相关议题的部门负责人）（简称'高级管理人员'）的考核指标之一，并将可持续发展绩效表现与高级管理人员薪酬绩效挂钩。作为绩效考核的一部分，伊利将包含温室气体减排目标、水资源管理目标在内的可持续发展战略目标的监督纳入高级管理人员的考核计划中，促使高级管理人员对可持续发展工作进展负责，切实推进可持续发展战略目标的实现。——《伊利股份2023年可持续发展报告》"
              />
            </el-form-item>
          </el-form>
        </div>
          ...
          >
            <el-form-item>
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】在满足强制性信息披露要求的基础上，广州酒家高度重视投资者需求，主动披露环境责任、社会责任、公司治理及经营等信息，持续提升公司信息披露有效性。——《广州酒家2023年度ESG报告》"
              />
            </el-form-item>
            <el-form-item>
              <template #label>
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】根据中国证监会颁布的《公开发行证券的公司信息披露内容与格式准则第2号——年度报告的内容与格式》《上海证券交易所上市公司自律监管指南第6号——定期报告》等要求，真实、准确、完整、及时、公平地披露2022年年度报告、2023年第一季度报告、2023年半年度报告、2023年第三季度报告。——《广州酒家2023年度ESG报告》"
              />
            </el-form-item>
          ...
          >
            <el-form-item>
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】公司不断优化投资者保护长效机制，持续完善投资者关系管理模式。公司通过投资者电话热线、邮箱、e互动、公司官网、公司官方微信公众号等多种渠道，传递公司信息，聆听投资者意见，增强投资者和公司之间的互信和理解。——《国投中鲁2023年度ESG报告》"
              />
            </el-form-item>
            <el-form-item label="投资者沟通活动类型">
              ...
              <el-input
                ...
                placeholder="【提示】公司高度重视与投资者特别是中小股东之间沟通渠道的多元和畅通，并建立起常态和多元化的投资者沟通机制。公司高度重视投资者的调研，专人负责投资者调研接待工作；公司官网设置投资者专区，投资者可在线预约参观调研；公司充分利用上交所互动平台，对投资者的问题给予及时解答和回复；并通过电话、邮件等多种方式服务投资者，及时向投资者传递公司最新的动态、经营业绩和方针。——《海天味业2023年环境、社会及治理报告》"
                type="textarea"
                :rows="4"
              />
            </el-form-item>
            ...
            <el-form-item label="附件上传" prop="investorInteractionFiles">
              ...
              <el-upload
                ...
                :on-change="handleFileChange"
                :before-upload="handleFileBeforeUpload"
                :on-success="handleUploadSuccess('investorInteractionFiles')"
                :on-remove="handleUploadRemove"
                drag
                :action="uploadUrl"
                :auto-upload="true"
            ...
            <el-form-item label="优秀投资者交流活动案例">
              ...
              <el-input
                ...
                placeholder="【提示】公司还会定期发起'走进上市公司'系列活动，在同投资者交流时，除了介绍公司情况业绩之外，还会实际参观公司的各个生产车间、宠物营养健康研究院、研发中心等核心区域，同时，我们也会在路演现场陈列公司产品，并对产品进行现场的讲解。投资者通过参观工厂可以了解到公司的生产情况，而触及到实际的产品才能加深对公司业务的印象，使投资者全方位的深入了解公司情况， 通过这样的直接互动，公司不仅传达了真实透明的信息，也进一步拉近了与投资者的距离，共同探讨和构筑长期共赢的合作关系。 ——《中宠股份2023年社会责任报告》"
                type="textarea"
                :rows="4"
              />
            </el-form-item>
            <el-form-item label="附件上传" prop="investorInteractionCaseFiles">
              ...
              <el-upload
                ...
                :before-upload="handleFileBeforeUpload"
                :on-success="
                  handleUploadSuccess('investorInteractionCaseFiles')
                "
                :on-remove="handleUploadRemove"
                drag
                :action="uploadUrl"
          ...
          >
            ...
            <el-form-item label="附件上传" prop="investorEducationFiles">
              ...
              <el-upload
                ...
                :on-change="handleFileChange"
                :before-upload="handleFileBeforeUpload"
                :on-success="handleUploadSuccess('investorEducationFiles')"
                :on-remove="handleUploadRemove"
                drag
                :action="uploadUrl"
                :auto-upload="true"
            ...
            <el-form-item label="投资者保护举措">
              ...
              <el-input
                ...
                placeholder="【提示】中粮糖业安排专职专岗开展投资者关系管理，重视信息披露，提高信息披露质量。严格按照《上海证券交易所股票上市规则》《信息披露事务管理制度》等相关规定，真实、准确、完整、及时地披露公司定期报告、临时公告，帮助投资者更便捷、更有效地了解公司经营情况，切实保障所有股东尤其是中小投资者对公司重大事项和经营管理情况的知情权。 ——《中粮糖业2023年度ESG报告》"
                type="textarea"
                :rows="4"
              />
            </el-form-item>
          ...
          >
            <el-form-item>
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】伊利秉承'强内控、防风险、促合规、创价值'的风控管理理念，逐步构建以风险和价值为导向、以控制为手段、以互联网技术为支撑、以制度为平台、以绩效管理为保障、以流程为对象的'六位一体'的内部控制与风险管理体系，并推动有效落实，推进全面风险管理。——《伊利股份2023年可持续发展报告》"
              />
            </el-form-item>
          ...
          >
            <el-form-item label="管理组织架构及职责">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】第一道防线:各业务及职能部门负责人负责部门相关风险的识别、评估、落实整改以及防范和化解潜在风险点;第二道防线:风险委员会对风险控制标准的执行情况进行监督;第三道防线:独立内部审计内审部负责定期对公司风险管理和合规流程有效性进行的内部审计，并将结果向审计委员会汇报；外部审计——《金龙鱼2023年可持续发展报告》"
              />
            </el-form-item>
            <el-form-item label="管理核心制度">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】基于《伊利集团内部控制与风险管理制度》及其配套管理流程，持续完善公司内部控制、风险管理及合规管理相关机制。——《伊利股份2023年可持续发展报告》"
              />
            </el-form-item>
            <el-form-item label="管理流程">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】针对关键领域和重点业务开展风险识别，并通过完成风险清单编制、确定风险等级及优先顺序、制定重大风险应对方案，进一步夯实公司风控管理体系，保障公司健康运行及可持续发展。 ——《伊利股份2023年可持续发展报告》"
              />
            </el-form-item>
            <el-form-item label="风险识别">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】目前，公司的风险矩阵中囊括了商业道德与反贪腐、产品质量管理、环境保护与资源节约、生产安全及食品安全管理等ESG风险控制点，有效地将企业ESG相关风险管理融合在现有的企业风险管控框架中。 ——《安井食品2023年ESG报告》"
              />
            </el-form-item>
            <el-form-item label="风险应对措施">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】公司内审部还根据重要性议题评估结果，将环保风险、劳工风险等、食品安全风险等主要的对公司长远发展及价值创造和对环境、社会具有重要影响的ESG风险纳入常规风险管理及内控机制当中，融入风险矩阵，制定专项检查及整改措施，全面提升风险防控质效。——《金龙鱼2023年可持续发展报告》"
              />
            </el-form-item>
          </el-form>
        </div>
          ...
          >
            <el-form-item label="商业道德理念或管理方针以及总体目标">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】水井坊根据《刑法》《反不正当竞争法》《关于办理商业贿赂刑事案件适用法律若干问题的意见》等各项法律法规、部委规章、司法解释规定，及公司《商业行为准则》，制定了《四川水井坊股份有限公司反贿赂政策》。该政策适用于水井坊及子公司与其所有员工，在接受礼品与招待、提供礼品与招待、与政府官员往来、公益捐赠、记录和记账规范、政策咨询等方面均做出了详细规定。——《水井坊2023年度ESG报告》"
              />
            </el-form-item>
          </el-form>
        </div>
          ...
          >
            <el-form-item label="平等对待中小企业">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】企业报告期末应付账款（含应付票据）余额超过300亿元或占总资产的比重超过50％的，应当披露报告期末逾期未支付的金额。企业或者其控股子公司通过国家企业信用信息公示系统向社会公示逾期尚未支付中小企业款项信息的，应当披露逾期未支付中小企业款项的金额、对中小企业供应商的账期设置情况、逾期账款的形成原因、是否涉及诉讼仲裁等情况。"
              />
            </el-form-item>
          </el-form>
        </div>
          ...
          >
            <el-form-item label="反腐廉洁组织架构及职责">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】公司全力打造'清廉一鸣',制定《浙江一鸣食品股份有限公司反舞弊制度》,防止各类舞弊事件发生,保障管理层有效履行管理工作。公司监察组主要负责开展反舞弊工作,通过规范公司员工的职业行为,保证公司各部门、中心制度规范运行,防止损害公司利益的行为发生。 公司监察组在董事会领导下独立行使职权,直接上级为董事长,不受业务部门、职能部门、行政部门的干涉和管理。公司监察组的监察工作向公司董事会及审计委员会负责并汇报工作。 ——《一鸣食品2023年ESG报告》"
              />
            </el-form-item>
            <el-form-item label="反腐廉洁政策">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】公司严格遵守国家法律法规，制定了《商业道德行为准则》《反腐败政策》《员工职务行为准则》等覆盖公司运营全流程的商业道德政策制度及管理机制，对全体员工、供应商、承包商、经销商等进行监管和约束，并对腐败、贿赂、舞弊、洗钱、不正当竞争、利益冲突等行为和不遵守情况做出明确的规范，同时将员工的年终考评和职务调整与员工行为准则相关联。公司持续完善商业道德管理体系，由董事会审计委员会进行总体监督。公司依据公司商业道德相关政策制度及管理中的要求，将运营中商业道德及违规风险纳入审计评估，每三年完成覆盖所有运营地的内部审计。 ——《金龙鱼2023年可持续发展报告》"
              />
            </el-form-item>
            <el-form-item label="腐败风险评估">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】公司开展关键岗位和重点人员的廉洁风险点识别，制定防控措施，2023年公司采购、销售、工程、财务、人事等重点条线识别出46个重大廉洁风险点。 ——《光明乳业2023年可持续发展报告》"
              />
            </el-form-item>
            ...
            <el-form-item label="反腐败举报渠道">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】双汇发展建立各类反腐败信息举报渠道，包括总裁直通车、稽查审计举报热线、采购吹哨人制度、各管理系统信息沟通平台、工厂经理信箱等，及时解决收到的举报，并充分保护举报人信息。 ——《双汇发展2023年社会责任报告》"
              />
            </el-form-item>
            <el-form-item label="举报人保护政策">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】公司保护举报人的正当权益不受侵害，对举报人的信息和举报事项予以保密。举报属实且为公司挽回损失的，酌情给予奖励。实名举报的，调查结果向举报人反馈。禁止以任何形式对举报人进行打击报复。——《国投中鲁2023年度ESG报告》"
              />
            </el-form-item>
            <el-form-item label="廉洁承诺书覆盖面">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】重大工程建设项目开工时，公司监管部门会在项目现场进行廉政教育，并要求施工单位、监理方须与公司签订三方廉洁协议，公司项目管理人员、施工方和监理公司等参与工程项目人员签署廉洁承诺；项目保证金中含有廉政保证金。——《光明乳业2023年可持续发展报告》"
              />
            </el-form-item>
            <el-form-item label="对商业伙伴反贪污，贿赂的监管">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】根据ESG审查方法，制订年度现场评审供应商名单，由供应商评审小组进行现场评审，并将评审结果反馈给供应商改进。供应商年度现场评审由公司内部相关专家组成现场评审小组或由第三方专业机构派遣专家组成现场评审小组，由现场评审小组作出评审结论，公司根据评审结论确定是否继续合作。——《光明乳业2023年可持续发展报告》"
              />
            </el-form-item>
            <el-form-item label="廉洁文化宣传渠道与措施">
              ...
              <el-input
                ...
                type="textarea"
                :rows="6"
                placeholder="【提示】公司采用多样化的形式开展廉洁自律宣传教育活动，旨在让廉洁文化深入人心。我们推出文化简报，以最新的资讯传递廉洁之声；举办廉洁专题宣传活动，深入剖析廉洁自律的重要性；开展廉洁文化快闪活动，以生动有趣的方式吸引员工参与；同时还打造了丰富的文化周边产品，以生动的方式强化对员工的廉洁教育。通过这些举措，我们不仅让廉洁文化变得可见，更使其成为企业文化的一部分，潜移默化地影响每位员工。2023年，海天通过公司内网、公告、宣传栏、学习平台、面授、沙龙、文化快闪等形式全方位对员工开展廉洁自律教育，警钟长鸣，共有10,380人次参加廉自律相关学习，8,699人次参加相关考试。——《海天味业2023年度ESG报告》"
              />
            </el-form-item>
            <el-form-item label="附件上传" prop="antiCorruptionFiles">
              ...
              <el-upload
                ...
                :on-change="handleFileChange"
                :before-upload="handleFileBeforeUpload"
                :on-success="handleUploadSuccess('antiCorruptionFiles')"
                :on-remove="handleUploadRemove"
                drag
                :action="uploadUrl"
                :auto-upload="true"
          ...
          >
            <el-form-item label="反垄断与公平竞争管理体系与制度">
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】双汇发展尊重市场竞争原则，支持和维护公平自由的市场竞争环境，反对任何形式的不正当竞双汇发展扎实推进反垄断体系优化工作，坚决支持和维护公平、自由的市场竞争环境，对任何形式的不正当竞争、垄断和洗钱行为持反对态度。2023年，我们关注反垄断规定最新动向，针对肉制品领域可能涉及的反垄断风险点及时修订完善《联销体协议》，进一步夯实反垄断管理。——《双汇发展2023年社会责任报告》"
              />
            </el-form-item>
            ...
            >
              ...
              <el-upload
                ...
                :on-change="handleFileChange"
                :before-upload="handleFileBeforeUpload"
                :on-success="handleUploadSuccess('antiMonopolyTrainingFiles')"
                :on-remove="handleUploadRemove"
                drag
                :action="uploadUrl"
                :auto-upload="true"
