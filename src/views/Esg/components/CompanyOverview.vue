          ...
          >
            ...
            <el-form-item label="公司组织架构图">
              <el-input
                ...
                type="textarea"
                :rows="6"
                placeholder="【提示】请列出将在ESG报告中纳入的所有实体（包含中文全称、简写、英文名称）"
                resize="vertical"
              />
            </el-form-item>
            ...
            <el-form-item label="附件上传" prop="reportingEntitiesFileList">
              <el-upload
                ...
                :on-success="handleUploadSuccess('reportingEntitiesFileList')"
...
——《佩蒂股份2024年ESG报告》"
            ...
            <el-form-item label="附件上传" prop="activitiesAndServicesFileList">
              <el-upload
                ...
                :before-upload="handleFileBeforeUpload"
                :on-success="
                  handleUploadSuccess('activitiesAndServicesFileList')
                "
                :on-remove="handleUploadRemove"
                drag
                :action="uploadUrl"
          ...
          >
            <el-form-item label="战略愿景">
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】成为人宠和谐健康生态的卓越建设者
Love Pets, Love Life."
              />
            </el-form-item>
            <el-form-item label="使命">
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】用全球好产品推动宠物健康标准升级
...
To carry out."
            ...
            <el-form-item label="发展战略">
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】六个全球化企业发展战略： “研发、标准、制造、供应链、市场和组织”"
              />
            </el-form-item>
          </el-form>
        </div>
          ...
          >
            ...
            <el-form-item label="附件上传" prop="externalInitiativesFileList">
              <el-upload
                ...
                :on-change="handleFileChange"
                :before-upload="handleFileBeforeUpload"
                :on-success="handleUploadSuccess('externalInitiativesFileList')"
                :on-remove="handleUploadRemove"
                drag
                :action="uploadUrl"
                :auto-upload="true"
          ...
          >
            <el-form-item>
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】请列出组织的主要协会成员资格"
              />
            </el-form-item>
            <el-form-item label="新闻链接">
              <el-input
                v-model="formData.associationMembershipNewsLink"
                placeholder="【提示】请输入相关新闻链接"
              />
            </el-form-item>
          ...
          >
            <el-form-item>
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】请描述公司及其子公司获得的重要荣誉奖项与颁奖单位"
              />
            </el-form-item>
          ...
          >
            <el-form-item>
              ...
              <el-input
                ...
                type="textarea"
                :rows="4"
                placeholder="【提示】请描述公司本年度发生的重大事件"
              />
            </el-form-item>
            <el-form-item label="新闻链接">
              <el-input
