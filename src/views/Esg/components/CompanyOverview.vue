            ...
            <el-form-item label="附件上传" prop="reportingEntitiesFileList">
              <el-upload
                ...
                :on-success="
                  () => {
                    // 遍历替换一边文件名
                    formData.reportingEntitiesFileList =
                      formData.reportingEntitiesFileList.map(item => ({
                        ...item,
            ...
            <el-form-item label="附件上传" prop="activitiesAndServicesFileList">
              <el-upload
                ...
                :on-success="
                  () => {
                    // 遍历替换一边文件名
                    formData.activitiesAndServicesFileList =
                      formData.activitiesAndServicesFileList.map(item => ({
                        ...item,
                        name: item.response.data.split('/').pop()
                      }));
                    handleSave('autoSave');
            ...
            <el-form-item label="附件上传" prop="externalInitiativesFileList">
              <el-upload
                ...
                :on-success="
                  () => {
                    // 遍历替换一边文件名
                    formData.externalInitiativesFileList =
                      formData.externalInitiativesFileList.map(item => ({
                        ...item,
                        name: item.response.data.split('/').pop()
                      }));
                    handleSave('autoSave');
...
//   if (props.activeTab === "company-overview" && props.isEdit) {
//     handleSave();
//   }
// }, autoSaveInterval);
// onUnmounted(() => {
